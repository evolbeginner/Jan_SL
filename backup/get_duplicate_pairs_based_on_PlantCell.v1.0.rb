...
def parse_orthomcl_file(infile, gene_prefix=nil, gene_suffix='')
...
def get_blast_pairs(blast_file, gene_prefix=nil, gene_suffix='', seq_info={}, is_paralogs=nil, gene_list=[])
  #all_pairs_of_a_gene=Hash.new{|h,k|h[k]=Hash.new{|h,k|}}
...
# raise "gene_list_file has to be given" if not gene_list_file


################################################################################
gene_list=read_gene_list_file(gene_list_file) if gene_list_file

seq_info = read_seq_file(seq_file,seq_file_suffix) if seq_file
is_paralogs = Is_paralogs.new(blast_args) if blast_args

pairs['orthomcl'] = parse_orthomcl_file(orthomcl_file,gene_prefix,gene_suffix)

blast_pairs = get_blast_pairs(blast_file,gene_prefix,gene_suffix,seq_info,is_paralogs,gene_list)
